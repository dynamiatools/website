...
<CardGrid stagger>
    ...
    <Card title="SDK Frontend - Construye UIs Modernas" icon="laptop">
        El **@dynamia-tools/sdk** es la librería cliente oficial de JavaScript/TypeScript para construir frontends web modernos con React, Vue, Angular, o cualquier framework.

        **Características Clave:**
        * **Soporte completo de TypeScript** con autocompletado y seguridad de tipos
        * **Cero dependencias en tiempo de ejecución** - Ligero y rápido
        * **Autenticación flexible** - Tokens Bearer, autenticación básica y sesiones
    ...
    <Card title="Lee la documentación" icon="open-book">
        ...
        ¡Consulta el [SDK Frontend](/es/frontend-sdk) para construir interfaces web modernas con React, Vue o Angular!
    </Card>
</CardGrid>
