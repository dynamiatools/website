...
Since version 26.x, DynamiaTools uses Calendar Versioning (`YY.MM.MINOR`, e.g. `26.7.0` = year 2026, month 07, release 0) instead of traditional semantic versioning, and the core platform, extensions, and themes all share a single unified version. See [History](/history) for the full story behind this change.