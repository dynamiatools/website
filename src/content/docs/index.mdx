...
<CardGrid stagger>
    ...
    <Card title="Frontend SDK - Build Modern UIs" icon="laptop">
        The **@dynamia-tools/sdk** is the official JavaScript/TypeScript client library for building modern web frontends with React, Vue, Angular, or any framework.

        **Key Features:**
        * **Full TypeScript support** with autocomplete and type safety
        * **Zero runtime dependencies** - Lightweight and fast
        * **Flexible authentication** - Bearer tokens, Basic Auth, and sessions
        * **Complete API coverage** - CRUD, actions, metadata, reports, files, and more
    ...
    <Card title="Read the docs" icon="open-book">
        ...
        Check out the [Frontend SDK](/frontend-sdk) to build modern web UIs with React, Vue, or Angular!
    </Card>
</CardGrid>
