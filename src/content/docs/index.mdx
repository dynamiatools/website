...
<CardGrid stagger>
    <Card title="What is Dynamia Platform?" icon="pencil">
        **Dynamia Platform** is the next generation of DynamiaTools—a unified, batteries-included framework for building Java 25 enterprise web applications fast and easy using standard design patterns, view descriptors for automatic UI generation, actions, services, and modules.
        ...
        Now with **CalVer versioning** (YY.MM.MINOR) and all modules unified in one version: **{version}**.
    </Card>
    ...
    <Card title="Frontend SDK - Build Modern UIs" icon="laptop">
        The new frontend stack is now modular:

        * **@dynamia-tools/sdk** as the core typed API client
        * **@dynamia-tools/vue** for metadata-driven Vue UIs (**beta**)
        * Extension SDKs for reports, files, and SaaS when needed

        <LinkButton href="/frontend-sdk" variant="secondary">
            Learn more about the SDK →
        </LinkButton>

        <LinkButton href="/vue-support" variant="minimal">
            Vue Support (Beta)
        </LinkButton>
    </Card>
    ...
    <Card title="Read the docs" icon="open-book">
        ...
        Check out [Frontend SDK](/frontend-sdk), [Vue Support (Beta)](/vue-support), and [Extensions](/extensions/) to build modern web frontends.
    </Card>
</CardGrid>
